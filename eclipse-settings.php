...
<div class="table-wrapper theme-setup">
	...
	<tr>
		...
		<td>
			...
			<fieldset>
				<input type="text" name="niteoCS_active_color_<?php echo esc_attr($themeslug);?>" id="niteoCS_active_color" value="<?php echo esc_attr( $active_color); ?>" data-default-color="#0099aa" class="regular-text code"><br>
			</fieldset>
	...
	<tr>
		...
		<td>
			...
			<fieldset>
				<input type="text" name="niteoCS_font_color_<?php echo esc_attr($themeslug);?>" id="niteoCS_font_color" value="<?php echo esc_attr( $font_color); ?>" data-default-color="#7a7a7a" class="regular-text code"><br>
			</fieldset>
		</td>
	</tr>
